...
import { icons }         from '@aufbau/icons/data';

const ICONIFY  = 'https://api.iconify.design';
const FALLBACK = 'material-symbols:help';

// the icon-name map now lives in @aufbau/icons (data/*.json) and is imported
// back here. interim coupling: it keeps short names ('save', 'chevron-down')
// resolving synchronously without inlining the table in this element. names
// already carrying a collection ('collection:name') never touch the map.
