...
const modules = [
  badTv, barrelBlur, blur, dotMatrix, duotone, edges, emboss, glitchHeavyCyber,
  glitchLive, glitchRgb, glow, grain, halftone, hueSaturation, instacolor, jitter,
  linocut, melt, nightVision, posterize, rainbow, rgbShift, scanlines, shake,
  sharpen, slices, smear, solarize, thermal, tiltShift, vignette, wave, wobble,
];
